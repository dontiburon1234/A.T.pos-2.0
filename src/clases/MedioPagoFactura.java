...
public class MedioPagoFactura {
	...
	public MedioPagoFactura(int id_caja, double numero, int id_medio_pago, int item, int id_entidad_bancaria,
			long tarjeta, long autorizacion, int numero_recibo, double valor_pago, double porcentaje_comision,
			double valor_comision, double valor_iva, double efectivo_recibido, Timestamp dg_fecha_accion,
			String dg_accion) {
		super();
