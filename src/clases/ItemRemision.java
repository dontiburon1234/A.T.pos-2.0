...
public class ItemRemision {
	...
	private double numero_remision; // numeric(20,0) NOT NULL,
	...
	public ItemRemision(int id_caja, double numero_remision, int item, int id_vendedor, String id_usuario_vendedor,
	...
	public double getNumero_remision() {
		return numero_remision;
	}

	public void setNumero_remision(double numero_remision) {
		this.numero_remision = numero_remision;
	}
