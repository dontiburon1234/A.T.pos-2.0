...
public class IntBotonesRapidos2 extends JPanel {
	...
	private int totalBotones = 50;

	public IntBotonesRapidos2() {
			...
			for (int i = 0; i < 5; i++) {
				...
				if(datosBRArray!=null){
					for (int l = 0; l < datosBRArray.getArrayDatosBR().size(); l++) {
						if(datosBRArray.getArrayDatosBR().get(l).getTabbed() == 2){
				...
				botonesRapidos[k].setMargin(new Insets(-30,0, 0,0));
