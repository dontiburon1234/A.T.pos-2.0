...
public class TablaFacturaModelo implements TableModel, TableModelListener  {

	private LinkedList<TablaArticulos> articulosList = new LinkedList<TablaArticulos>();
	private LinkedList<TableModelListener> listeners = new LinkedList<TableModelListener>();

	
	@Override
	public void tableChanged(TableModelEvent e) {
		System.out.println("TablaFacturaModelo.tableChanged() "+e.getSource());
	}
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		aux = (TablaArticulos)(articulosList.get(rowIndex));
	...
	public void adicionaArticulo(TablaArticulos tablaArticulos) {
		// Añade el sartículo al modelo 
		articulosList.add(tablaArticulos);
	...
	public void borraArticulo(int rowDelete) {
		try {
			...
			if(rowDelete!=-1) articulosList.remove(rowDelete);
			...
			System.err.println("TablaFacturaModelo.borraArticulo() ERROR rowDelete "+rowDelete+" tamnaño "+articulosList.size());
			e.printStackTrace();
		}
	}
